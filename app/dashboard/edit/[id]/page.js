          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                {(formData.templateId === "minimalist-romance" || formData.templateId === "dark-moody-elegant" || formData.templateId === "royal-glamour" || formData.templateId === "neon-nightclub" || formData.templateId === "elegant-milestone" || formData.templateId === "playful-kidsparty" || formData.templateId === "summer-poolparty") && (
